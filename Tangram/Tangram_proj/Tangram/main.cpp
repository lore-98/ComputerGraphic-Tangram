...
const std::vector<Model> SceneToLoad = {
	{"piece1.obj", "A.png", {0,0,0}, 1, Flat},
	{"piece2.obj", "B.png", {0,0,0}, 1, Flat},
	{"piece3.obj", "L.png", {0,0,0}, 1, Flat},
	{"piece4.obj", "P.png", {0,0,0}, 1, Flat},
	{"piece5.obj", "T.png", {0,0,0}, 1, Flat},
	{"piece6.obj", "V.png", {0,0,0}, 1, Flat},
	{"piece7.obj", "Z.png", {0,0,0}, 1, Flat},
	{"tray.obj", "TR.png", {0,0,0}, 1, Flat}
...
private:
	...
	void initWindow() {
		...
		window = glfwCreateWindow(WIDTH, HEIGHT, "Tangram", nullptr, nullptr);
		glfwSetWindowUserPointer(window, this);
		glfwSetFramebufferSizeCallback(window, framebufferResizeCallback);
	}

	static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
		auto app = reinterpret_cast<TangramApplication*>
...
*/
	...
	void createInstance() {
		...
		appInfo.pApplicationName = "Tangram";
